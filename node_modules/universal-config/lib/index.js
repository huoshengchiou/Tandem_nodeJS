...
var Config = (function () {
  ...
  _createClass(Config, [{
    ...
    value: function getServerVars() {
      ...
      if (this._env === 'server') {
        try {
          serverVars = require('../../../src/config/server');
        } catch (e) {
    ...
    value: function getClientVars() {
      ...
      try {
        clientVars = require('../../../src/config/client');
      } catch (e) {
        clientVars = {};
    ...
    value: function getLocalOverrides() {
      ...
      try {
        overrides = process.env.NODE_ENV === 'production' ? require('../../../src/config/prod') : require('../../../src/config/dev');
